::BattleStats <- {
    TitleName       = "Battling Details",
    TooltipText = {
        TitleLifetime   = "Lifetime Stats:",
        TitlePerks      = "Perk Stats:",
        TitleLastBattle = "Last Battle Stats:" ,

        LifeHPDamage        = "Dealt H %d+B %d=%d HP",
        LifeMeleeAttack     = "Land=%d, Attack=%d, Hit=%d%%",
        LifeRangedAttack    = "Land=%d, Shoot=%d, Hit=%d%%",
        LifeHeadblowAttack  = "Land=%d, Hit=%d%%, Damage=%d%%",
        LifeBeingHit        = "Be Hit=%d, Shot=%d, Dodge=%d%%",
        LifeBeingHitHead    = "Be Blowed=%d, Hit=%d%%, Damage=%d%%",

        LastHPDamage        = "Dealt H %d+B %d=%d HP",
        LastArmorDamage     = "Dealt H %d+B %d=%d Armors",
        LastMeleeAttack     = "Land=%d, Attack=%d, Hit=%d%%",
        LastRangedAttack    = "Land=%d, Shoot=%d, Hit=%d%%",
        LastHeadBlowAttack  = "Blow=%d, Hit=%d%%",
        LastHPReceive       = "Recv H %d+B %d=%d HP",
        LastArmorRecive     = "Recv H %d+B %d=%d Armors",
        LastBeingHit        = "Be Hit=%d, Shot=%d, Dodge=%d%%",
        LastBeingHitHead    = "Be Blowed=%d, Hit=%d%%, Damage=%d%%",

        PerkExecutioner     = "Effectual=%d(%d%%,%d%%), Trigger=%d(%d%%)",
        PerkFastAdaption    = "Effectual=%d(%d%%), Trigger=%d(%d%%)",
        Perk9LPrefix        = "9L save you from dead ",
        Perk9LTimes1        = "once.",
        Perk9LTimes2        = "twice.",
        Perk9LTimesN        = " times.",
    }
